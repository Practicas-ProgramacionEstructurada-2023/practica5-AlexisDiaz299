...
namespace MyApp// Note: actual namespace depends on the project name.
{
    internal class Program
    {
         static void Main(string[] args)
        {
            ...
            Console.WriteLine("Ingrese nota del laboratorio 1: ");
            ...
            Console.WriteLine("\nIngrese las notas del primer computo");
            Console.WriteLine("Ingrese nota del laboratorio 2: ");
            ...
            {
                Console.WriteLine("Usted saco una nota menor que 6, reprobo la materia.\n");
            }
            Console.ReadKey();
        }
    }
